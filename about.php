...
<body>
  ...
  <div class="content">
    <h2>Quản Lý Trang Thông Tin</h2>

    <h3>Danh Sách Trang Thông Tin</h3>
    <div>
      <?php require 'detail/show_informationpages.php'; ?>
    </div>

    <div>
      <h3>Thêm Trang Thông Tin</h3>
      <form action="add.php" method="post" id="edit_form">
        ...
        <input type="submit" name="add_informationpages" value="Thêm Trang Thông Tin">
      </form>
    </div>
  </div>
